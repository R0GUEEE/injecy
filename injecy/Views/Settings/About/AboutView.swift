...
struct AboutView: View {
	...
	var body: some View {
		NBList(.localized("About")) {
			...
			NBSection(.localized("Legal")) {
				Link(destination: URL(string: "https://leadproject.lol/privacy")!) {
					Label(.localized("Privacy Policy"), systemImage: "hand.raised")
				}
				Link(destination: URL(string: "https://leadproject.lol/terms")!) {
					Label(.localized("Terms of Use"), systemImage: "doc.text")
				}
				Link(destination: URL(string: "https://leadproject.lol/content-policy")!) {
					Label(.localized("Content Policy"), systemImage: "checkmark.shield")
				}
			}
