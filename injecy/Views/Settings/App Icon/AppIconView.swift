...
struct AppIconView: View {
	...
	var sections: [String: [AltIcon]] = [
		"Main": [
			AltIcon(displayName: "injecy", author: "Samara", key: nil),
			AltIcon(displayName: "injecy (macOS)", author: "Samara", key: "V2Mac"),
			AltIcon(displayName: "injecy v1", author: "Samara", key: "V1"),
			AltIcon(displayName: "injecy v1 (macOS)", author: "Samara", key: "V1Mac"),
			AltIcon(displayName: "injecy v0", author: "Samara", key: "V0"),
			AltIcon(displayName: "injecy Donor", author: "Samara", key: "Donor")
		],
		"Wingio": [
			AltIcon(displayName: "injecy", author: "Wingio", key: "Wing"),
		]
	]
